...
/*
 * Testcase 13:
 * Test basic memory region confing in SRCMD_FMT0/1 and MDCFG_FMT0/1/2 in
 * priority entry with iopmp.msi_en and IMSIC
...
int main(void)
{
	...
	*(volatile unsigned int *)&CPU_RO_Array[0] = 0x7777CCCC;
	...
	printf("IOPMP testcase13 success.\n");
	while(1);
}
